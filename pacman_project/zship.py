...
class Ship(Sprite):
    ship_images = [pg.transform.rotozoom(pg.image.load(f'images/Ship-{n}.png'), 0, 1.7) for n in range(3)]
    # ship_images = [pg.transform.rotozoom(pg.image.load(f'images/ship.bmp'), 0, 1)]
