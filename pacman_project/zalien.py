...
class Alien(Sprite):
    ...
    alien_images0 = [pg.transform.rotozoom(pg.image.load(f'images/Alien1-{n}.png'), 0, 3) for n in range(9)]
    alien_images1 = [pg.transform.rotozoom(pg.image.load(f'images/Alien2-{n}.png'), 0, 3) for n in range(5)]
    alien_images2 = [pg.transform.rotozoom(pg.image.load(f'images/Alien3-{n}.png'), 0, 3) for n in range(4)]
